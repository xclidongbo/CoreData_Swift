...
//        var ties:[Bowtie]?
//        do {
//            ties = try managedObjectContext.executeFetchRequest(request) as? [Bowtie]
...
//        print("Name: \(sample.name), worn: \(sample.lastWorn)")
    ...
    lazy var applicationDocumentsDirectory: NSURL = {
        // The directory the application uses to store the Core Data store file. This code uses a directory named "lidongbo.Test_CoreData_Chapter2" in the application's documents Application Support directory.
    ...
    lazy var managedObjectModel: NSManagedObjectModel = {
        ...
        let modelURL = NSBundle.mainBundle().URLForResource("Test_CoreData_Chapter2", withExtension: "momd")!
